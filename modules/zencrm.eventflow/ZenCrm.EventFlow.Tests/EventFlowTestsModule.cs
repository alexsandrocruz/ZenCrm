...
[AdditionalAssembly(typeof(EventFlowModule))]
public class EventFlowTestsModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // EventFlowDbContext ()
        new EventFlowDbContext(
            new DbContextOptionsBuilder<EventFlowDbContext>().UseSqlite(connection).Options
